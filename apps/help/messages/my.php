...
$messages = array(
 ...
 /**
   ...
   /**
    ...
    "Enter"=>"Enter the username which you want to search.",
    ...
    "Start Date"=>"Select Search Start Date",
    "End Date"=>"Select Search End Date",
    ...
    "Add User"=>"Add User(For Admin)",
    "Admin can create"=>"Admin can create new SALTS member.",
    "Edit"=>"Edit",
    "Admin can edit of user informations."=>"Admin can edit of user informations.",
