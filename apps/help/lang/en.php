...
$messages = array(
    ...
    "Today Attendance List" => "Today Attendance Lists",
    "Monthly Attendance List" => "Monthly Attendance Lists",
    "Manage User" => "Manage Users",
    "Leave Days" => "Leave Days",
    "Apply Leave" => "Apply Leave",
    "Leave Lists" => "Leave Lists",
    "Leave Setting" => "Leave Setting",
    "Calendar" => "Calendar",
    "Salary" => "Salary",
    "Add Salary" => "Add Salary",
    "Salary Lists" => "Salary Lists",
    "Monthly Salary Lists" => "Monthly Salary Lists",
    "Salary Setting" => "Salary Setting",
    "Allowance" => "Allowance",
    "Document" => "Document",
    "Letter Head" => "Letter Head",
    "SSB & Tax Document" => "SSB & Tax Document",
    /**
     * Search Help
     */
