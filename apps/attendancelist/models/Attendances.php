...
class Attendances extends Model {
    ...
    public function GetAbsentList() {
        $query = "Select * from core_member where member_id IN (Select member_id from attendances where att_date = CURRENT_DATE and status = 2 or status = 1) AND deleted_flag=0 order by created_dt desc";
