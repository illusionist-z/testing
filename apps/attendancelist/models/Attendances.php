...
class Attendances extends Model {
    ...
    /**
     * Search today attendance list
     * @param type $username
     * @return type
     * @author zin mon
     */
    public function search_todayattlist($username) {
        try {
            $today = date("Y:m:d");

            //show att today list
            $query = "select * from core_member JOIN attendances On core_member.member_id = attendances.member_id where attendances.att_date ='" . $today . "' and core_member.member_login_name='" . $username . "'";
