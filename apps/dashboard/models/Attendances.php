...
class Attendances extends Model {
    ...
    public function checkleave(){
        ...
        $query ="select member_login_name from core_member as c join absent as a on c.member_id=a.member_id where a.deleted_flag=0 group by a.member_id order by count(*) desc limit 3";
