...
$messages = array(
   ...
   "ssc_comp" => "SSC_Com",
    ...
    "item" => "အခ်က္အလက္",
    "bsalary" => "အေျခခံလစာ",
    "overtime_rate" => "အခ်ိန္ပိုုေၾကးႏႈန္း",
    "overtime_hour" => "အခ်ိန္ပိုုနာရီ",
    "overtime_payment" => "အခ်ိန္ပိုုေၾကး",
    "allowance_for_specific" => "အက်ဳိးခံစားခြင္႔",
    "gross_salary" => "စုစုေပါင္းလစာေငြ",
    "deduce_for_absent" => "ပ်က္ကြက္ေၾကး",
    "personal_income" => "အခြန္",
    "ssb_employee" => "လူမႈဖူလံုုေရး",
    "subtotal" => "ႏူတ္ယူေငြ",
    "rounded_up" => "လက္က်န္ေငြစုစုေပါင္း",
    "commute_fee" => "ခရီးစရိတ္",
    "grand_total" => "စုစုေပါင္း",
