...
var todaylist = function () {
    var username = document.getElementById('namelist').value;
    
     //window.location.href = baseUri + 'attendancelist/search/searchtoday?username=' + username;
    $.ajax({
        url: baseUri + 'attendancelist/search/searchtoday?username=' + username ,
        type: 'GET',
        success: function (d) {                       
            var json_obj = $.parseJSON(d);//parse JSON            
           $('tbody').empty();
