               ...
               var data ='<form id="Add_new_deduct"><table>';               
                   data += '<tr><td></td></tr>'
                        ...
                        +'<tr><td><small>'+d.deduc_amount+'</small></td><td style="font-size:10px;"><input style="margin-top:10px;" type="text" value="" name="amount" placeholder=" '+d.write_amount+' "></td></tr>'
                         ...
                         +'<tr><td></td></tr>';             
               data +='<tr><td></td><td colspan="3"><br><a href="#" class="button" id="Add_deduct">'+d.save+'</a><a href="#" class="button" id="cancel_deduct">'+d.cancel+'</a></td></tr>';
               data +='</table></form>';
               Deduction.Diaadd(data,d.sett_title);
           }
        });
        },
