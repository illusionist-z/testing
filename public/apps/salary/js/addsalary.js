    ...
    Submit: function () {
        $.ajax({
            ...
            success: function (d) {
                ...
                {
                    $('#add_salary_bsalary').css('border', 'black');
                    $('#add_salary_ssc').css('border', 'black');
                    $('#add_salary_uname_error').empty();
                    $('#add_salary_bsalary_error').empty();
                    ...
                    for (var i in cond) {
                        switch (i) {
                            ...
                            case 'uname' :
                                $("#add_salary_uname").css({border: "1px solid red", color: "red"});
                                $('#add_salary_uname_error').text(cond[i]).css({color: 'red'});
                                repair('#add_salary_uname');
                                break;
