            ...
            success: function (d) {
                ...
                if (cond.result === 'error')
                {
                    ...
                    for (var i in cond) {
                        switch (i) {
                            ...
                            case 'sdate'   :
                                ...
                                break;
                            case 'edate'    :
                                $("#apply_form_edate").css({border: "none", color: "red"});
                    ...
                    if (cond.success) {
                        ...
                        $("#apply_form_edate_error").empty();
                        alert(cond.error);
                        $('#apply_form_sdate').css({border: '1px solid red'});
                        repair('#apply_form_sdate');
                        $('#apply_form_edate').css({border: '1px solid red'});
                        repair('#apply_form_edate');
                    }
                }
            }
        });
