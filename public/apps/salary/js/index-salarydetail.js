...
//    });
    ...
    $('.btnEditInfo').click(function () {
        ...
        //  document.getElementById('btn_savedetail').disabled=true;
...
//        document.getElementById('txtallowance').disabled=false;
        var cells = document.getElementsByClassName("btn_savedetail");
        for (var i = 0; i < cells.length; i++) {
            cells[i].disabled = false;
            cells[i].style.backgroundColor = "#3c8dbc";
        }
        var textbox = document.getElementsByClassName("txtenable");
    ...
    $("#btn_savedetail").click(function () {
        ...
        $.ajax({
            type: 'get',
            url: baseUri + 'salary/salarymaster/editsalarydetail?bsalary='
                    + b_salary + '& overtime=' + overtime_rate +
                    '& specific_dedce=' + specific_duty_allowance +
                    ' & member_id=' + member_id + '&absent=' + absent +
                    '& year=' + year + '&month=' + month + '&overtime_hr=' + overtime_hr,
