            ...
            success: function (res) {
                ...
                if (res[0] !== 'new') {
                    html = '<form id="edit_user" width="250px" height="200px"><table width="420px" height="100px" align="center" style="font-size:13px;">'
                            ...
                            + '<tr><td>SSN No: </td>'
                            + '<td><input style="margin-top:10px;" type="text" value="' + res[0].ssn_no + '" name="ssn" id=""></td></tr>'
                            ...
                            + '<tr><td>Myanmar Name</td>'
                            + '<td><input style="margin-top:10px;" type="text" value="' + res[0].mm_name + '" name="mm_name" id="edit_mm_name"></td></tr>'
